...
public class phDashBoard extends JFrame {

	private JPanel contentPane;
	private AddInfoPanel addinfoPanal;
	private editInfoPanel editinfoPan;
	private GetInfoPanelPh GetInfoPanelPh;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					phDashBoard frame = new phDashBoard();
	...
	public phDashBoard() {
		...
		GetInfoPanelPh = new GetInfoPanelPh();
	    ...
	    */
		...
		lblExit.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (JOptionPane.showConfirmDialog(null, "Are you sure you want to close this applicaiton",
						"Confirmation", JOptionPane.YES_NO_OPTION) == 0) {
					phDashBoard.this.dispose();
				}
			}
		...
		paneMainContent.add(GetInfoPanelPh);
		menuClicked(addinfoPanal);
		menuClicked(addinfoPanal);
	}
	...
	public void menuClicked(JPanel panel) {
		...
		GetInfoPanelPh.setVisible(false);
